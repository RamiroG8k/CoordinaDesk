...
const Ticket = () => {
    ...
    return (
        <section className="flex flex-col w-screen h-screen items-center dark:bg-gray-800">
            {loading && <p>Loading...</p>}

            {(!loading && ticket) && <div className="flex flex-col w-full max-w-5xl p-4 sm:p-10 justify-center items-center space-y-4">
                <div className="sticky top-4 flex w-full dark:text-white bg-gray-100 dark:bg-gray-700 rounded-3xl px-4 py-8 justify-between items-center shadow-inner">
                    ...
                    {ticket.ticketContent.map((e, i) => {
                        ...
                        return (
                            <div key={e.created_at}
                                ...
                                <p className="font-semibold dark:text-white">{e.username}</p>
                ...
                <div className="flex w-full">
                    <textarea id="answer" rows={2} value={data} onChange={({ target: { value } }) => setData(value)}
                        className="w-full input rounded-xl bg-blue-100 bg-opacity-60 dark:bg-gray-600" />
